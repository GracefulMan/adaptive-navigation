...
from rl.agent import ReplayBuffer, ReplayBufferMP
...
def demo1_discrete_action_space():
    ...
    from rl.agent import AgentD3QN  # AgentDQN,AgentDuelDQN, AgentDoubleDQN,
...
def demo2_continuous_action_space_off_policy():
    ...
    '''choose an DRL algorithm'''
    from rl.agent import AgentModSAC  # AgentSAC, AgentTD3, AgentDDPG
